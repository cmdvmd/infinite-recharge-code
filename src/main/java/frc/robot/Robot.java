...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    drivetrain.setDefaultCommand(new RunCommand(Robot.drivetrain::drive, Robot.drivetrain));
    climber.setDefaultCommand(new RunCommand(Robot.climber::climb, Robot.climber));
  }
